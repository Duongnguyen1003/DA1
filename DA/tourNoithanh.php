            ...
            <div class="mt-10">
                ...
                ?>
                    <article>
                        ...
                        <a class="" href="../../DA1/DA/customer.php">
                            <img class="rounded-md" src="../../DA1/assets/img/<?php echo $voucher['voucher_image'] ?>" alt="">
                            <div class="">
                            ...
                            <p class="py-2 text-right uppercase text-yellow-500 underline group-hover:text-blue-600 text-sm">
                                xem ngay</p>
                        </a>
        ...
        <div class="relative col-span-10 mx-10">
            <div>
                ...
                <div class="flex justify-between">
                    <div class="">
                        <form method="post">
                            <button name="tour_new" class="px-3 py-2 text-sm bg-white mx-2 border border-black hover:border-yellow-400">Tour
                                mới</button>
                            <button name="tour_love" class="px-3 py-2 text-sm  mx-2 border border-black hover:border-yellow-400">Tour
                                Yêu Thích</button>

                            <button name="tour_sale" class="px-3 py-2 text-sm bg-white mx-2 border border-black hover:border-yellow-400">Tour
                                khuyến mãi</button>
                        </form>
                    </div>
                    <form method="POST">
                        <select class="px-3 py-2 text-sm bg-white mx-2 focus:outline-none border border-black hover:border-yellow-400" name="check_price" id="">
                            <option value="price">Giá</option>
                            <option value="0">Giá: Thấp đến cao</option>
                            <option value="1">Giá: Cao đến thấp</option>
                        </select>
                        <select class="px-3 w-40 py-2 text-sm bg-white mx-2 focus:outline-none border border-black hover:border-yellow-400" name="check_place" id="">
                        ...
                        <input class="px-10 py-2 text-sm bg-blue-300 mx-2 focus:outline-none border border-black hover:border-yellow-400" type="submit" name="search_filter" id="" value="Tìm kiếm">
                    </form>
                </div>
            </div>
            <div class="grid grid-cols-4 gap-5 mt-5">
                ...
                ?>
                    <article class="group shadow-lg rounded-md">
                        <a href="../../DA1/DA/product.php?id_tour=<?php echo $values['id_tour'] ?>">
                            <div class="overflow-hidden rounded-md border border-white">
                                <img style="height: 172px;width: 283px;" class="transition duration-300 transform group-hover:opacity-80 object-fill" src="../../DA1/assets/img/<?php echo $values['image_main'] ?>" alt="">
                            </div>

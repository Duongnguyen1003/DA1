        ...
        <section class="bg-white my-5">
            <div class="container mx-auto grid grid-cols-12 gap-10 justify-center">
                <div class="col-span-6 my-5 bg-white m-2">
                    <div class="slider-for object-fill bg-gray-100">
                        <div class="focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_main'] ?>" alt="" style="width: 732px; height: 446px;"></div>
                        <div class="focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_detail'] ?>" alt="" style="width: 732px; height: 446px;"></div>
                        <div class="focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_plan1'] ?>" alt="" style="width: 732px; height: 446px;"></div>
                        <div class="focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_plan2'] ?>" alt="" style="width: 732px; height: 446px;"></div>
                        <div class="focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_plan3'] ?>" alt="" style="width: 732px; height: 446px;"></div>
                    </div>
                    <div class="slider-nav bg-gray-100 mt-5">
                        <div class="px-1 focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_detail'] ?>" alt="" style="width: 203px; height: 123px;">
                        </div>
                        <div class="px-1 focus:outline-none"><img class="object-fill" src="./content/image/1.jpg" alt="" style="width: 203px; height: 123px;">
                        </div>
                        <div class="px-1 focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_plan1'] ?>" alt="" style="width: 203px; height: 123px;">
                        </div>
                        <div class="px-1 focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_plan2'] ?>" alt="" style="width: 203px; height: 123px;">
                        </div>
                        <div class="px-1 focus:outline-none"><img class="object-fill" src="../assets/img/<?php echo $totall1['image_plan3'] ?>" alt="" style="width: 203px; height: 123px;">
                        </div>
                    </div>
                ...
                <div class="col-span-6 my-5 bg-gray-100 bg-opacity-50">
                    ...
                    <div class="px-5">
                        ...
                        <div class="my-10">
                            <a href="cart.php?id_tour=<?php echo $totall1['id_tour'] ?>" class=" text-black border hover:border-yellow-400 px-12 py-3 w-full text-base rounded bg-red-400 hover:bg-white text-center">Đặt
                                ngay</a>
                        </div>
                    ...
                    <div class="col-span-9 bg-gray-100 p-5 bg-opacity-50">
                        <div>
                            ...
                            <div class="mt-5">
                                ...
                                <img class="mx-auto my-5 object-fill" src="../assets/img/<?php echo $totall1['image_detail'] ?>" alt="" style="width: 600px; height: 366px;">
                            </div>
                        </div>
                        <div>
                            <div class="my-5">
                            ...
                            <div>
                                ...
                                <img class="mx-auto my-5 object-fill" src="../assets/img/<?php echo $totall1['image_plan1'] ?>" alt="" style="width: 600px; height: 366px;">
                            </div>
                            <div>
                                <p>
                                ...
                                <img class="mx-auto my-5 object-fill" src="../assets/img/<?php echo $totall1['image_plan2'] ?>" alt="" style="width: 600px; height: 366px;">
                            </div>
                            <div>
                                <p>
                                ...
                                <img class="mx-auto my-5 object-fill" src="../assets/img/<?php echo $totall1['image_plan3'] ?>" alt="" style="width: 600px; height: 366px;">
                            </div>
                        </div>
                        <div class="mt-10">
                            <div class="">
                                ...
                                <article>
                                    <a class="group shadow-lg rounded-md" href="">
                                        <div class="overflow-hidden rounded-md border border-white">
                                            <img class="transition duration-300 transform group-hover:opacity-80 object-fill" src="../../DA1//assets/img/<?php echo $row['image_main'] ?>" alt="" style="width: 302px; height: 185px;">
                                        </div>
            ...
            <div class="<?php
                ...
                <form class="mx-10 mb-5 bg-white py-2" method="POST" enctype="multipart/form-data">
                    <div class="flex items-center px-10 w-40 ">
                        <img class="rounded-lg w-20 h-20 object-fill" src="../../DA1/assets/img/<?php echo $showuser['user_image'] ?>" alt="">
                        <span class="px-3 font-bold block"><?php echo $showuser['fullname'] ?></span>
                    </div>

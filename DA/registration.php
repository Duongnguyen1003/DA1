        ...
        <section class="mx-96 border my-10 px-32 py-10 shadow-md">
            ...
            <form method="POST" enctype="multipart/form-data" class="px-40">
                <div class="my-4">
                    ...
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" type="text" placeholder="" id="users_name" name="username" required>
                </div>
                <!-- end user name -->
                <div class="my-4">
                    <span>Mật khẩu</span>
                ...
                <div class="my-4">
                    <span>Họ và tên</span>
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" type="text" placeholder="" id="lastname" name="fullname" required>
                </div>
                <!-- end lastname -->
                <div class="my-4">
                    <span>Email</span>
                ...
                <div class="my-4">
                    ...
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" pattern="0[0-9\s.-]{9,13}" type="tel" placeholder="" id="phone" name="phone" required>
                </div>
                <div class="my-4">
                    <span>Địa chỉ</span>
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" type="text" placeholder="" id="phone" name="address" required>
                </div>
                <!-- end phone -->
                <div class="my-4">
                ...
                <div class="mt-4 flex justify-end">
                    ...
                    <p class="inline-block ">Bạn đã có tài khoản <a href="login.php" class="text-blue-400">Đăng nhập</a>
                        ngay!</p>
                </div>

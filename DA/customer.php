                ...
                ?>
                    <article class="one">
                        <div class="screen">
                            ...
                            <div class="next">
                                <button class=" bg-yellow-400 w-40 py-3 border hover:bg-white hover:border-yellow-400 focus:outline-none">Xem
                        ...
                        <div class="show pt-5 hidden">
                            ...
                            <div class="text-left">
                                <h3>Mã Voucher: <span class="font-bold"><?php echo $voucher['voucher_code'] ?></span></h3>
                                <p>
                                    <?php
                            ...
                            <div class="prev">
                                <button class="mt-10 bg-yellow-400 w-40 py-3 border hover:bg-white hover:border-yellow-400">Xem
        ...
        <section class="text-left py-12 bg-white">
            ...
            <div class="grid grid-cols-3 gap-10 container mx-auto px-20">
                <div class="col-span-1">
                    <img class="py-10" src="../../DA1/assets/img/z2441349567188_31b9578ae6c5e49629cd4562a937e306.jpg" alt="">
                </div>
                <!-- col1 -->

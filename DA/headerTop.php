        ...
        <ul>
            <li class="inline-block pr-5 hover:text-black relative group">
                <span href="login.php" class="group">
                    ...
                    <a href="../../DA1/DA/login.php"><span class="inline-block text-base text-white group-hover:text-yellow-500 <?php
                                                                                                                                if (isset($_SESSION['user'])) {
                                                                                                                                    ...
                                                                                                                                    echo 'block';
                                                                                                                                } ?>"><i class="fas fa-sign-in-alt py-2 pr-3"></i>Đăng
                            nhập</span></a>
                ...
                <div class="absolute top-0 mt-5 pl-5 group-hover:block hidden  <?php
                    ...
                    <ul>
                        <li class="bg-white pl-5 w-40 py-1 font-bold text-black hover:text-blue-500 "><a class="" href="../../DA1/DA/changeinforuser.php?user=<?php echo $totals['username'] ?>">Quản lý
                                tài khoản</a></li>
                        <form method="POST">
                            <li class="bg-white pl-5 w-40 py-1 font-bold text-black hover:text-blue-500 "><input type="submit" name="Logout" value="Đăng xuất" id="" class="bg-white font-bold"></li>
                        </form>

        ...
        <section class="mx-96 border my-10 px-32 py-10 shadow-md">
            ...
            <form method="POST" enctype="multipart/form-data" class="px-40">
                ...
                <div class="my-4">
                    ...
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" type="password" placeholder="" id="pass" name="password" required>
                </div>
                <!-- end password -->
                <div class="my-4">
                    <label>Mật khẩu mới</label>
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" type="password" placeholder="" id="pass" name="passnew" required>
                </div>
                <div class="my-4">
                ...
                <div class="my-4">
                    ...
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" value="<?php echo $total['fullname'] ?>" type="text" placeholder="" id="lastname" name="fullname" required>
                </div>
                <!-- end lastname -->
                <div class="my-4">
                    <label>Email</label>
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" value="<?php echo $total['email'] ?>" type="email" placeholder="" id="email" name="email" required>
                </div>
                <!-- end mail -->
                <div class="my-4">
                    <label>Số điện thoại</label>
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" value="<?php echo $total['phone_number'] ?>" pattern="0[0-9\s.-]{9,13}" type="tel" placeholder="" id="phone" name="phone" required>
                </div>
                <div class="my-4">
                    <label>Địa chỉ</label>
                    <input class="my-1 px-2 py-1 border focus:outline-none block w-full" value="<?php echo $total['address'] ?>" type="text" placeholder="" id="phone" name="address" required>
                </div>
                <!-- end phone -->
                <div class="my-4">
                    <label>Ảnh đại diện</label>
                    <img class="w-20 object-cover" src="../assets//img//<?php echo $total['user_image'] ?>" alt="">
                    <input class="my-1 px-2 py-1  focus:outline-none block w-full" type="file" placeholder="" id="img" name="image">
                </div>
                <!-- end image -->
                <div class="mt-10 border-none relative flex justify-center">
                    ...
                    <div>
                        <button class="mx-48 bg-red-400 border rounded-lg px-10 py-2 text-lg focus:outline-none hover:bg-blue-300 hover:text-black transform hover:translate-x-10 transition duration-150" name="btn_regis">Cập nhật </button>
                    </div>
                </div>
                <!-- end submit -->
            </form>

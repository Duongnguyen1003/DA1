...
<body class="nunito relative">
    <div id="main">
        ...
        <main class="container mx-auto">
            <section class="flex container mx-auto my-10">
                ...
                <i class="fas fa-angle-right px-3 items-center flex text-sm text-gray-400"></i>
                <h3><a class="uppercase text-sm" href="tourNoithanh.php?id_category=<?php echo $parent ?>">đặt tour</a>
                </h3>
            </section>
            <section class="grid grid-cols-7 gap-5">
                ...
                <form method="POST" class="border p-5 col-span-3">
                    ...
                    <div class="mt-3">
                        <span>Họ và tên</span>
                        <input class="my-1 bg-gray-100 bg-opacity-50 px-2 py-1 border focus:outline-none block w-full" type="text" placeholder="Tên đăng nhập" value="<?php echo $showuser['fullname'] ?>" id="lastname" name="fullname" required>
                    </div>
                    <!-- end lastname -->
                    <div class="mt-3 ">
                        <span>Email</span>
                    ...
                    <div class="mt-3 ">
                        ...
                        <input class="my-1 bg-gray-100 bg-opacity-50 px-2 py-1 border focus:outline-none block w-full" type="text" placeholder="Số điện thoại" id="phone" name="phone_number" value="<?php echo $showuser['phone_number'] ?>" required>
                    </div>
                    <div class=" mt-3">
                        <span>Địa chỉ</span>
                        <input class="my-1 bg-gray-100 bg-opacity-50 px-2 py-1 border focus:outline-none block w-full" type="text" placeholder="Địa chỉ" id="address" name="adress" value="<?php echo $showuser['address'] ?>" required>
                    </div>
                    <div class=" mt-3">
                        <span>Người lớn</span>
                    ...
                    <div class="my-5 flex justify-between">
                        ...
                        <button id="voucher" type='button' class="voucher text-blue-500 hover:text-red-600 cursor-pointer flex items-center justify-end pl-1" name="choseV">Chọn
                            VOUCHER</button>
                    </div>
                    ...
                    <div class="flex justify-end">
                        <p class="mt-5">Tổng tiền: <span class="text-red-500 text-2xl font-bold italic" id="allPrice">000</span>
                            ₫</p>
                    </div>
    ...
    <div id="selectVoucher" class="absolute bottom-0 mx-170 my-180 items-center hidden border bg-white">
        <div class="relative">
            ...
            <form method="POST">
                <div class="flex py-3 justify-items-center bg-gray-100 px-5 my-2">
                    ...
                    <input id="codeVoucher" value="" class="border px-3 focus:outline-none mx-5 py-2 w-80" type="text" placeholder="Mã giảm giá" name="code_voucher">
                </div>
                <button id="apply" name="check_code" class="py-2 px-8 absolute border bg-yellow-500  " style="right:20px; top:69px;">Áp
                    dụng</button>
            </form>
            <?php
                    ...
                    <div class="voucherLL">
                        <div class="grid grid-cols-4 gap-5 cursor-pointer mx-5 my-5 shadow-md">
                            ...
                            <div class=" col-span-2">
                                ...
                                <ul>
                                    <li class="list-inside list-disc py-1">Giảm <span class="font-bold"><?php echo $voucher['voucher_sale']  ?>%</span> tổng giá
                                        tiền
                                        cho các tour</li>
                                </ul>
                            </div>
        ...
        <div class="flex justify-end mx-5 my-10">
            <button id="back" class="border hover:bg-yellow-500 border-yellow-500 px-14 py-1 mx-3 focus:outline-none">Trở
                lại</button>
